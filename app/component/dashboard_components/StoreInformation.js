...
function StoreInformation({ setPaymentTracker, setFormPage, dropData }) {
  ...
  const submitStore = () => {
    ...
    if (Validation()) {
      ...
      storeInfo.signed_document &&
        formData.append("signed_document", storeInfo.signed_document);
 ...
 {err?.countryReg && (
  <p className="text-red-600 text-[12px] pt-[5px]">Please include country of registration</p>
            ...
            <Box>
              <DashBoardInput
                required
                placing={"Nakasero market@gmail.com"}
                icon={
                  <svg
                    width="20"
                    height="20"
           ...
           <Box>
            ...
            <Box>
              <DashBoardInput
                ...
                placing={"Limited"}
                names={"bussinessType"}
                values={storeInfo.bussinessType}
                handleChange={handleInputChange}
                label={"Business type"}
              />
              {err?.bussinessType ? (
                <p className="text-red-600 text-[12px] pt-[5px]">
                  Please include Business type
                </p>
              ) : (
                <p className="text-red-600 text-[12px] pt-[5px]"></p>
              )}
            ...
            <Box>
              <LocationInput
                ...
                updateStates={setStoreInfo}
                names={"addressOne"}
                values={storeInfo.addressOne}
            ...
            <Box className=" w-11/12 m-auto">
              <Box>
                <Box
                  borderBottom="2px"
                  borderColor="#92DF16"
                  className=" w-fit pt-[20px]"
                >
                  <Text className=" pb-[2px] font-bold ">
                    Seller’s Contract{" "}
                  </Text>
                </Box>
              </Box>
              <Box className=" mt-[25px]">
                <Text className=" text-[12px]">
                  Please, download the Bringo Seller’s contract, sign and upload
                  ...
                  <Button backgroundColor={"#0E4940"}>
                    <Box className=" flex items-center p-[2px] gap-x-[20px]">
                      <Box>
                        ...
                        >
                          <path
                            d="M11.1673 15.7734L4.69556 9.30168L6.50765 7.42487L9.87297 10.7902V0.241211H12.4617V10.7902L15.827 7.42487L17.6391 9.30168L11.1673 15.7734ZM3.40121 20.9509C2.68931 20.9509 2.07989 20.6974 1.57293 20.1904C1.06598 19.6835 0.8125 19.074 0.8125 18.3621V14.4791H3.40121V18.3621H18.9334V14.4791H21.5221V18.3621C21.5221 19.074 21.2687 19.6835 20.7617 20.1904C20.2548 20.6974 19.6453 20.9509 18.9334 20.9509H3.40121Z"
                            fill="#F5ECBE"
                          />
                        </svg>
                      </Box>
                ...
                >
                  <Box className=" flex items-center p-[2px] gap-x-[20px]">
                    <Box>
                      ...
                      >
                        <path
                          d="M9.6425 15.7734V5.22447L6.27718 8.58979L4.46509 6.71297L10.9369 0.241211L17.4086 6.71297L15.5965 8.58979L12.2312 5.22447V15.7734H9.6425ZM3.17074 20.9509C2.45884 20.9509 1.84942 20.6974 1.34246 20.1904C0.835509 19.6835 0.582031 19.074 0.582031 18.3621V14.4791H3.17074V18.3621H18.703V14.4791H21.2917V18.3621C21.2917 19.074 21.0382 19.6835 20.5312 20.1904C20.0243 20.6974 19.4149 20.9509 18.703 20.9509H3.17074Z"
                          fill="#98A2B3"
                        />
                      </svg>
                    </Box>
              ...
              {err?.signed_document ? (
                <p className="text-red-600 text-[12px] pt-[5px]">
                  Please download and upload signed document
                </p>
              ) : (
                <p className="text-red-600 text-[12px] pt-[5px]">required</p>
              )}
              <Box className=" mt-[30px] pb-[20px]">
                <Text className=" text-[#007AFF] text-[12px]">
                  Bringo policies and guidelines | Privacy policy | Cookie
                </Text>
              </Box>
            </Box>
          </Box>
