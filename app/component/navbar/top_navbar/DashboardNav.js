...
function DashboardNav() {
  ...
  return (
    <Box
      position={"unset"}
      className=" lg:grid hidden bg-white h-[80px] grid items-center bg-white"
    >
              ...
              icon={
                <Box className=" flex items-center gap-x-[5px] ">
                  ...
                  <Box className=" ">
                    ...
                    >
                      <path
                        d="M3.65702 3.16483L0.882812 0.390625H6.43122L3.65702 3.16483Z"
                        fill="#535961"
                      />
                    </svg>
                  </Box>
