...
function DashboardDeskSide({
  ...
  const ErrorPops = () => {
    toast({
      title: "Error",
      description:
        (Object.keys(businessData).length < 1 &&
          "Please Complete your Business information and Subscribe") ||
        (ProfileObject?.subStatus &&
          "Please Set Up Your store and payment information"),
      status: "error",
      duration: 5000,
      isClosable: true,
      position: "top-right",
