    ...
    <div>
      <Box className=" text-white lg:mt-[40px] mt-[20px]">
        ...
        <Text className=" text-[15px] pt-[20px]">
          Please, enter your phone number and password to create an account.
        </Text>
      </Box>
      ...
      <Box className=" grid gap-y-[20px] mt-[40px]">
        ...
        <Box>
          ...
          {touched.password && errors.password && (
            <p className="text-red-500 text-xs pt-2">{errors.password}</p>
          )}
        </Box>
        ...
        <Box>
          <Unboarding_input
            password
            values={signUpDetails.confirmPassword}
            handleChange={handleSignUpChange}
            handleBlur={handleBlur}
