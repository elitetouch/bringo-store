...
export const TableCard = ({ item }) => {
  ...
  return (
    <Box key={item.id} className="">
      <Box
        key={item.id}
        className=" grid h-[62px] items-center bg-white rounded-lg "
      >
                ...
                <Box className=" flex items-center gap-x-[5px]">
                  <Box className=" flex items-center gap-x-[5px]">
                    <Box
                      ...
                      className=" text-[12px] rounded-full  h-[20px] w-[20px] grid items-center justify-center"
                    >
                      <Text className="">{item.remainingItems}</Text>
                    </Box>
      ...
      <Box>
        {handleDropDown && (
          <Box className=" grid gap-y-[20px] pb-[20px] pt-[20px]">
            <Box className="grid grid-cols-5 gap-x-[20px]">
              <Box className=" col-span-2">
                <Text className=" text-right text-[14px] text-[#737373]">
                  Price
                </Text>
              </Box>
            ...
            <Box className="grid grid-cols-5 gap-x-[20px]">
              ...
              <Box className=" col-span-3 text-[14px] font-semibold">
                <Box className=" grid h-[29px] w-fit rounded-l-full rounded-r-full items-center justify-center bg-[#FFDCDC]">
                  <Text className=" text-[#FF0000] text-[12px] pl-[10px] pr-[10px]">
                    {item.status}
                  </Text>
                </Box>
              </Box>
  ...
  return (
    <div className=" lg:hidden grid gap-y-[15px] bg-white pt-[20px] pb-[20px]">
      {Data.length > 0 ? (
        ...
        <Box>
          <Text className=" mt-[20px] text-center">No Available Data</Text>
        </Box>
      )}
    </div>
  );
...
export default MobileOutletsTable;
