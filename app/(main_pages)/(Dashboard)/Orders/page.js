...
import Filter from "@/app/component/dashboard_components/Filter";
import ExportButton from "@/app/component/dashboard_components/ExportButton";
...
import OrderTable from "@/app/component/Table/OutletTable";
export const OrderBreakDown = ({ title, sum, price, last_title }) => {
  return (
    <Box
      borderLeft={title != "Total Returned" && "1px"}
    ...
    >
      <Box className=" lg:w-10/12 m-auto w-11/12">
        <Box className=" justify-between items-center flex">
          <Text
            className={`text-[#1570EF] ${(title === "Total Received" && "text-[#E19133]") || (title === "Total Returned" && "#845EBC") || (title === "On the way" && "#F36960")}`}
          >
            {title}
          </Text>
        </Box>
        <Box className=" justify-between items-center flex">
          ...
          <Text className=" lg:text-[15px] text-[14px]  mt-[15px]">
            {price}
          </Text>
        </Box>
        <Box className=" justify-between items-center flex">
          <Text className=" text-[#858D9D] lg:text-[15px] text-[14px] mt-[15px]">
            Last 7 days
          </Text>
          <Text className=" text-[#858D9D] lg:text-[15px] text-[14px] mt-[15px]">
            {last_title}
    ...
    >
      <Box className=" pt-[20px] ">
        <Box className="grid bg-white w-11/12 m-auto rounded-lg  ">
          <Box className=" w-11/12 m-auto pt-[15px]">
            <Text className=" font-semibold lg:text-[20px] text-[18px] ">
              Overall Orders
            </Text>
          </Box>
          <Box className="flex  items-center gap-x-[20px] bg-white w-11/12 m-auto mt-[15px] pb-[15px] ">
            ...
            <Box className=" grid lg:grid-cols-3 w-full grid-cols-2 gap-y-[20px] gap-x-[10px]">
              <Box className=" w-11/12 m-auto lg:hidden grid">
                <Text className=" text-[#1570EF]">Total Orders</Text>
                <Text className=" text-[15px]  mt-[15px]">0</Text>
                <Text className=" text-[#858D9D] text-[14px] mt-[15px]">
                  Last 7 days
                </Text>
              </Box>
              <OrderBreakDown
      ...
      <Box className=" bg-white w-11/12 m-auto rounded-lg mt-[20px]">
        ...
        <Box
          ...
          borderColor="gray.300"
          borderRadius="lg"
          className=" lg:h-[45px] grid items-center w-11/12 m-auto mt-[20px]"
        >
