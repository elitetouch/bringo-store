...
//import imp from '../Subscription/SubscriptionPages/Billhistory'
    ...
    return(
        <Box className=' h-[56px] grid items-center bg-white rounded-lg '>
            <Box className=' flex items-center gap-x-[20px] w-11/12 m-auto'>
                <Box>
                    <Button onClick={()=>router.push('/Subscription')} className=''>
                        <Text>Subscription</Text>
                    </Button>
                </Box>
                <Box>
                     <Button onClick={()=>router.push(`/Subscription/SubscriptionPages/Billhistory`)}>
