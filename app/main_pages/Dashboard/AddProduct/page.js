...
export const SectionAndCategory = [
  {
    id: 1,
    sectionName: "",
    sectionAvatar: "",
  ...
  return (
    <Box>
      <Box className=" flex items-center lg:gap-x-[10px] gap-x-[3px]">
        ...
        >
          <path
            d="M7.49998 11C7.08577 11 6.74999 10.6642 6.75 10.25L6.75006 6.74999C6.75007 6.33577 7.08586 5.99999 7.50007 6C7.91428 6.00001 8.25006 6.3358 8.25006 6.75001L8.25 10.25C8.24999 10.6642 7.9142 11 7.49998 11Z"
            fill="#303030"
          />
          <path
          ...
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M14.5 7C14.5 10.866 11.366 14 7.5 14C3.63401 14 0.5 10.866 0.5 7C0.5 3.13401 3.63401 0 7.5 0C11.366 0 14.5 3.13401 14.5 7ZM13 7C13 10.0376 10.5376 12.5 7.5 12.5C4.46243 12.5 2 10.0376 2 7C2 3.96243 4.46243 1.5 7.5 1.5C10.5376 1.5 13 3.96243 13 7Z"
            fill="#303030"
          />
        </svg>
      </Box>
      <Box className=" w-full pt-[10px]">
        <Box
          ...
          borderRadius="lg"
          className=" w-full grid items-center rounded-lg "
        >
...
function Page() {
  ...
  useEffect(() => {
    console.log({ categoty_value: category_value });
  }, [category_value]);
  ...
  const EditFunc = (id) => {
    ...
    //   formData.append("category_id", 1);
    // formData.append("category_name", category_value)
    changedFields.productTitle &&
      formData.append("product_title", changedFields.productTitle);
    changedFields.brandName &&
      formData.append("brand_name", changedFields.brandName);
    ...
    changedFields.StockQuantity &&
      formData.append("quantity", changedFields.StockQuantity);
    changedFields.amount &&
      formData.append("sales_price", changedFields.amount);
    changedFields.featureOne &&
      formData.append("key_feature[]", changedFields.featureOne);
    changedFields.featureTwo &&
      formData.append("key_feature[]", changedFields.featureTwo);
    changedFields.featureThree &&
      formData.append("key_feature[]", changedFields.featureThree);
    changedFields.featureFour &&
      formData.append("key_feature[]", changedFields.featureFour);
    // Append nested object (location)
    ...
    changedFields.min_amount &&
      formData.append("price[minimum_amount]", changedFields.min_amount); //
    changedFields.sug_amount &&
      formData.append("price[suggested_amount]", changedFields.sug_amount); //
    ...
    axiosInstance
      .post(`/api/v1/edit-store-product/${id}`, formData)
      .then((resp) => {
        console.log(resp);
        queryClient.invalidateQueries();
        toast({
        ...
        <Box className=" bg-white pt-[20px] w-11/12 m-auto rounded-lg pb-[30px]">
          <Box className=" grid lg:grid-cols-5 gap-y-[20px] w-11/12 m-auto gap-x-[20px]">
            <Box className=" lg:col-span-3">
              <Box className=" lg:w-full m-auto">
                <Box>
                      ...
                      <Box className=" ">
                        <Box>
                          <PriceInput
                            ...
                            names={"amount"}
                            changes={addProductChange}
                            values={addProduct.amount}
                            title={"Amount"}
                            placing={
                              Object.keys(singleProduct).length > 0
                            ...
                            <Box className=" grid grid-cols-2 gap-y-[20px] gap-x-[20px] mt-[20px]">
                              <Box>
                                <PriceInput
                                  ...
                                  names={"min_amount"}
                                  changes={addProductChange}
                                  values={addProduct.min_amount}
                                  title={"Minimum amount"}
                                  placing={
                                    Object.keys(singleProduct).length > 0
                                      ? singleProduct?.price?.minimumAmount
                                      : ""
                                  }
                                />
                                {err?.min_amount && (
                                  <p className="text-red-600 text-[12px] pt-[5px]">
                                    Please include minimum amount
                                  </p>
                                )}
                              </Box>
                              <Box>
                                <PriceInput
                                  ...
                                  names={"sug_amount"}
                                  changes={addProductChange}
                                  values={addProduct.sug_amount}
                                  placing={
                                    Object.keys(singleProduct).length > 0
                                      ? singleProduct?.price?.suggestedAmount
                                      : ""
                                  }
                                />
                                {err?.sug_amount && (
                                  <p className="text-red-600 text-[12px] pt-[5px]">
                                    Please include suggested amount
                                  </p>
                                )}
                              </Box>
                            </Box>
                        ...
                        <Box className=" flex justify-between w-11/12 m-auto">
                          <Box className=" flex items-center gap-x-[5px] w-full">
                            <Box>
                              ...
                              >
                                <path
                                  d="M1.25 0.0644531C0.835786 0.0644531 0.5 0.40024 0.5 0.814453C0.5 1.22867 0.835786 1.56445 1.25 1.56445H2.86199C2.98863 1.56445 3.09526 1.65915 3.11023 1.7849L4.15028 10.5213C4.25508 11.4016 5.00154 12.0645 5.88801 12.0645H12.25C12.6642 12.0645 13 11.7287 13 11.3145C13 10.9002 12.6642 10.5645 12.25 10.5645H5.88801C5.76137 10.5645 5.65474 10.4698 5.63977 10.344L5.54696 9.56445H11.8979C13.3349 9.56445 14.5296 8.45811 14.6398 7.02537L14.9978 2.37198C15.0138 2.16368 14.9422 1.95815 14.8003 1.80487C14.6583 1.65159 14.4589 1.56445 14.25 1.56445H10V5.50379L11.2197 4.28412C11.5126 3.99123 11.9874 3.99123 12.2803 4.28412C12.5732 4.57702 12.5732 5.05189 12.2803 5.34478L9.78033 7.84478C9.48744 8.13768 9.01256 8.13768 8.71967 7.84478L6.21967 5.34478C5.92678 5.05189 5.92678 4.57702 6.21967 4.28412C6.51256 3.99123 6.98744 3.99123 7.28033 4.28412L8.5 5.50379V1.56445H4.59405C4.4704 0.705756 3.73393 0.0644531 2.86199 0.0644531H1.25Z"
                                  fill="#303030"
                                />
                                <path
                                  d="M8 14.0645C8 14.6167 7.55228 15.0645 7 15.0645C6.44772 15.0645 6 14.6167 6 14.0645C6 13.5122 6.44772 13.0645 7 13.0645C7.55228 13.0645 8 13.5122 8 14.0645Z"
                                  fill="#303030"
                                />
                                <path
                                  d="M13 14.0645C13 14.6167 12.5523 15.0645 12 15.0645C11.4477 15.0645 11 14.6167 11 14.0645C11 13.5122 11.4477 13.0645 12 13.0645C12.5523 13.0645 13 13.5122 13 14.0645Z"
                                  fill="#303030"
                                />
                              </svg>
                            </Box>
                            <Box className=" w-full flex-1 ">
                              <Select
                                placeholder="Select Section and Category"
                  ...
                  <Box>
                    <Box>
                      ...
                      <Box className=" mt-[10px]">
                        <RadioGroup
                          onChange={(value) => {
                            const parsed = JSON.parse(value); // convert string back to object
                            setCategoryValue(parsed);
                            console.log("Selected Item Object:", parsed);
                          }}
                          value={
              ...
              >
                <Box className=" w-11/12 m-auto pt-[10px] pb-[10px]">
                  ...
                  <Text className=" text-[#454545] text-[14px] pt-[10px]">
                    <span className=" font-semibold">Note :</span> Format photos
