...
function ProductSearch({placing}) {
  return (
    <Box border="1px" borderColor="gray.300" borderRadius="lg" className=' lg:w-[400px] w-full grid items-center '>
        <Box className=' border flex items-center rounded-lg'>
                <Input border={'none'} placeholder={placing} className=' flex-1 text-[12px]' />
            <Box>
                <IconButton
