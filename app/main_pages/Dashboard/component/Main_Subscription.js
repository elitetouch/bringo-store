...
//import imp from '../../../main_pages/Dashboard/Subscription/SubscriptionPages/ChoosePlan'
...
Get started today and grow your grocery business with Bringo, where convenience meets control.</Text>
            ...
            <Box className=' mt-[20px]'>
                <Button onClick={()=>router.push('/../../../main_pages/Dashboard/Subscription/SubscriptionPages/ChoosePlan')} border={'1px'} rounded={'lg'} borderColor={'#007460'} color={'#007460'} backgroundColor={'transparent'}>
