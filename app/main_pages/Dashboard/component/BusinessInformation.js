...
function BusinessInformation({setbusinessTracker}) {
 ...
 handleChange={handlePaymentChange}
  label={'*Business registration number'} /> 
                       ...
                       <DashboardFileUpload attachFile={setPaymentData} names={'certificate'} label={'*Certificate of Registration'} />  
                          <DashBoardInput placing={''} names={'taxNumber'} values={paymentData.regNumber} handleChange={handlePaymentChange} label={'Tax Identification Number (TIN)'} />               
