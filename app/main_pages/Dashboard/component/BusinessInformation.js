       ...
       <Box borderBottom="2px" borderColor="#92DF16"  className=' w-fit'>
                      ...
                      <Text className=' text-[#332F2F] text-[12px] pt-[15px]'>Please provide the following details of your business</Text>
                       <Box className=' grid lg:grid-cols-2 gap-y-[20px] lg:gap-x-[40px] mt-[20px] lg:mt-[20px]'>
                        <Box>
                       <DashBoardInput placing={SingleBussinessData?SingleBussinessData.companyName:'Nakasero'} icon={<svg width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
values={paymentData.regNumber}
 handleChange={handlePaymentChange}
  label={'*Business registration number'} /> 
                      <Box>
                       <DashboardFileUpload
                       UploadedFileName={SingleBussinessData?SingleBussinessData.cac02:''}
  ...
  <p className="text-red-600 text-[12px] pt-[5px]">Please upload your CAC</p>
                      ...
                      <Box>
                       <DashboardFileUpload 
                        UploadedFileName={SingleBussinessData?SingleBussinessData.cacCertificate:''}
  ...
  <p className="text-red-600 text-[12px] pt-[5px]">Please upload your Certificate of registration</p>
                      ...
                      <Box>
                          <DashBoardInput placing={''} names={'taxNumber'} values={paymentData.taxNumber} handleChange={handlePaymentChange} label={'Tax Identification Number (TIN)'} />               
 {err?.taxNumber && (
  <p className="text-red-600 text-[12px] pt-[5px]">Please input Tax identification number</p>
                        ...
                        <Box>
                         <DashboardFileUpload UploadedFileName={SingleBussinessData?SingleBussinessData.companyLogo:''} attachFile={setPaymentData} names={'logo'} label={'Company logo'} />
                           {err?.logo && (
      ...
      <Box  className=' pb-[40px]'>
        <Box borderBottom="2px" borderColor="#92DF16"  className=' w-fit pt-[30px]'>
                       ...
                       <Text className=' text-[#332F2F] text-[12px] pt-[15px]'>Please provide the following details of the owner / legal representative of your business</Text>
                        <Box className=' grid lg:grid-cols-2 gap-y-[20px] lg:gap-x-[40px] mt-[20px] lg:mt-[20px]'>
                          <Box>
                          <DashBoardInput placing={SingleBussinessData?SingleBussinessData.repFullname:'Naruto Uzumaki'} 
names={'fullName'} 
 ...
 handleChange={handlePaymentChange}
  ...
  <p className="text-red-600 text-[12px] pt-[5px]">Please input your full name</p>
   ...
   <CountryDropDown
                ...
                placing={SingleBussinessData?SingleBussinessData.repIdType:'Select ID type'}
                />
   {err?.idType && (
  <p className="text-red-600 text-[12px] pt-[5px]">Please select an appropriate ID type</p>
                          ...
                          <Box>
                 <DashBoardInput placing={SingleBussinessData?SingleBussinessData.repIdNumber:'Enter ID number'} 
names={'idNumber'} 
values={paymentData.idNumber}
 ...
 {err?.idNumber && (
  ...
  <DashboardFileUpload attachFile={setPaymentData} names={'cerfification'} label={'*Certificate of Registration'} />
      ...
      <Box>
{SingleBussinessData?.id?<Box className={` ${mobilePage===0||mobilePage===1?'hidden lg:grid':'grid'} w-11/12 justify-end`}>
            <SubmitButton 
             Edit={'Edit'}
            submitFunc={
