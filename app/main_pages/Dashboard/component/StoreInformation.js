...
function StoreInformation({setPaymentTracker}) {
    ...
    <div className=' w-11/12 m-auto pb-[30px] '>
        <Box borderBottom="2px" borderColor="#92DF16"  className=' w-fit'>
                ...
                <Box className=' grid lg:grid-cols-2 gap-y-[20px] lg:gap-x-[40px] mt-[20px] lg:mt-[20px]'>
                     <DashBoardInput placing={'Nakasero market@gmail.com'} icon={<svg width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
           ...
           <Box>
            ...
            <Box className=' w-full'>
               <Unboarding_input dashboard placing={''}  names={'PhoneNumber'} values={storeInfo.PhoneNumber} handleChange={handleInputChange} label={'Phone number'} />
                ...
                <CountryDropDown
                 values={storeInfo.countryReg}
                onChangeFunc={handleInputChange}
                 names={'countryReg'}
                 label={'Country of registration'}
                />
              <DashBoardInput placing={'Company'}  names={'company'} values={storeInfo.company} handleChange={handleInputChange} label={'Business type'} /> 
              ...
              <DashBoardInput placing={'State/region'}  names={'state'} values={storeInfo.state} handleChange={handleInputChange} label={'State/Region'} /> 
