...
required
                     ...
                     placing={'Nakasero'} icon={<svg width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<Box>
              <DashBoardInput
              required
              placing={'Nakasero market@gmail.com'} icon={<svg
  width="20"
  height="20"
  viewBox="0 0 20 20"
  fill="none"
...
{/* <p className="text-gray-600 text-[12px] pt-[5px]">Create a new bussiness information on bussiness information tab </p> */}
              ...
              <DashBoardInput
              required
              placing={'Limited'}  names={'bussinessType'} values={storeInfo.bussinessType} handleChange={handleInputChange} label={'Business type'} /> 
                 {err?.bussinessType? (
  <p className="text-red-600 text-[12px] pt-[5px]">Please include Business type</p>
                ...
                <DashboardFileUpload
                required
                attachFile={setStoreInfo} names={'Shop_Logo'} label={'Upload Shop Logo'} />
                <p className="text-red-600 text-[12px] pt-[5px]"></p>
                </Box>
                <Box>
                <LocationInput
  ...
  <p className="text-red-600 text-[12px] pt-[5px]">Please include State</p>
              ...
              <DashBoardInput
              required
              placing={'Postal code'}  names={'postalCode'} values={storeInfo.postalCode} handleChange={handleInputChange} label={'Postal code'} />
                 {err?.postalCode? (
