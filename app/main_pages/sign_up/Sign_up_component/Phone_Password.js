         ...
         <Box className=' flex items-center gap-x-[10px]'>
           <Box>
            ...
            <Box className=' w-full'>
               <Unboarding_input values={signUpDetails.phone} handleChange={handleSignUpChange} names={'phone'} placing={''} />
            </Box>
         </Box>
          <Box>
            <Unboarding_input values={signUpDetails.password} handleChange={handleSignUpChange} names={'password'} placing={'Password'} icon={<svg
  width="20"
  height="20"
  viewBox="0 0 20 20"
  fill="none"
...
>
  ...
  />
           ...
           <Box>
            <Unboarding_input values={signUpDetails.confirmPassword} handleChange={handleSignUpChange} names={'confirmPassword'} placing={'Confirm password'} icon={<svg
  width="20"
  height="20"
  viewBox="0 0 20 20"
  fill="none"
